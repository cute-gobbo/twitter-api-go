...
func (a *BookmarksApiService) GetUsersIdBookmarks(ctx context.Context, id string, localVarOptionals *BookmarksApiGetUsersIdBookmarksOpts) (GenericTweetsTimelineResponse, *http.Response, error) {
	var (
...
*/
func (a *BookmarksApiService) PostUsersIdBookmarks(ctx context.Context, body AddBookmarkRequest, id string) (BookmarkMutationResponse, *http.Response, error) {
	var (
