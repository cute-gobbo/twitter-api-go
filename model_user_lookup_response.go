...
func (o UserLookupResponse) MarshalJSON() ([]byte, error) {
...
type NullableUserLookupResponse struct {
	value *UserLookupResponse
	isSet bool
}

func (v NullableUserLookupResponse) Get() *UserLookupResponse {
	return v.value
}

func (v *NullableUserLookupResponse) Set(val *UserLookupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUserLookupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUserLookupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserLookupResponse(val *UserLookupResponse) *NullableUserLookupResponse {
	return &NullableUserLookupResponse{value: val, isSet: true}
}

func (v NullableUserLookupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserLookupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
