...
func (o SingleUserLookupResponse) MarshalJSON() ([]byte, error) {
...
type NullableSingleUserLookupResponse struct {
	value *SingleUserLookupResponse
	isSet bool
}

func (v NullableSingleUserLookupResponse) Get() *SingleUserLookupResponse {
	return v.value
}

func (v *NullableSingleUserLookupResponse) Set(val *SingleUserLookupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSingleUserLookupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSingleUserLookupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSingleUserLookupResponse(val *SingleUserLookupResponse) *NullableSingleUserLookupResponse {
	return &NullableSingleUserLookupResponse{value: val, isSet: true}
}

func (v NullableSingleUserLookupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSingleUserLookupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
